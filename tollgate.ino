...
void rfid()
{
  ...
  if (content.substring(1) == "F3 AE 38 FB")
  {
    if (card1Balance >= 500)
    {
      lcdPrint();
  ...
  else if (content.substring(1) == "72 7E B1 55")
  {
    if (card2Balance >= 500)
    {
      lcdPrint();
  ...
  if (KState == PRESSED)
  {
    ...
    if (Key)
    {
      if (Key == '#')
      {
        ...
        {
          num1 = Data;
          card2Balance = num1.toInt() + card2Balance;
          lcd.clear();
          lcd.setCursor(0, 0);
        ...
        {
          num2 = Data;
          card1Balance = num2.toInt() + card1Balance;
          lcd.clear();
          lcd.setCursor(0, 0);
          lcd.print("Your current");
          lcd.setCursor(0, 1);
